...
public class DefaultCreatures : MonoBehaviour
{
    ...
    public CombatUnit getFromEnum(Enums.Enemy e){
        ...
        switch(e){
            case Enums.Enemy.Rat:
                ...
                pref = Instantiate(Resources.Load<GameObject>("Prefabs/rat"));
                send.setUnitSprite(pref);
                return send;
            case Enums.Enemy.Boar:
                send = (CombatUnit)boar.Clone();
                pref = Instantiate(Resources.Load<GameObject>("Prefabs/boar"));
                send.setUnitSprite(pref);
                return send;
            case Enums.Enemy.Falcon:
                send = (CombatUnit)falcon.Clone();
                pref = Instantiate(Resources.Load<GameObject>("Prefabs/falcon"));
                send.setUnitSprite(pref);
                return send;
            case Enums.Enemy.Pigeon:
                send = (CombatUnit)pigeon.Clone();
                pref = Instantiate(Resources.Load<GameObject>("Prefabs/pigeon"));
                send.setUnitSprite(pref);
                return send;
            case Enums.Enemy.Raccoon:
                send = (CombatUnit)raccoon.Clone();
                pref = Instantiate(Resources.Load<GameObject>("Prefabs/raccoon"));
                send.setUnitSprite(pref);
                return send;
        }
        return null;
    ...
    public CombatUnit getRat(){
        ...
        GameObject pref = Instantiate(Resources.Load<GameObject>("Prefabs/rat"));
        send.setUnitSprite(pref);
        return send;
    }
    public CombatUnit getPigeon(){
        CombatUnit send = (CombatUnit)pigeon.Clone();
        GameObject pref = Instantiate(Resources.Load<GameObject>("Prefabs/pigeon"));
        send.setUnitSprite(pref);
        return send;
    }
    public CombatUnit getBoar(){
        CombatUnit send = (CombatUnit)boar.Clone();
        GameObject pref = Instantiate(Resources.Load<GameObject>("Prefabs/boar"));
        send.setUnitSprite(pref);
        return send;
    }
    public CombatUnit getRaccoon(){
        CombatUnit send = (CombatUnit)raccoon.Clone();
        GameObject pref = Instantiate(Resources.Load<GameObject>("Prefabs/raccoon"));
        send.setUnitSprite(pref);
        return send;
    }
    public CombatUnit getFalcon(){
        CombatUnit send = (CombatUnit)falcon.Clone();
        GameObject pref = Instantiate(Resources.Load<GameObject>("Prefabs/falcon"));
        send.setUnitSprite(pref);
        return send;
    }
